...
$('#action-button').on('click', function () {
    ...
    $('.view-attachment').on('click', function (e) {
        ...
        // Handle Edit button click to open the modal with the selected post's data
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        if (post.attachment_url) {
                            ...
                            $('#edit-post-attachment-url').val(post.attachment_url); // Store the current attachment URL
                        } else {
                            $('#edit-post-attachment-preview').hide();
                            $('#edit-post-attachment-url').val(''); // Clear the input if no attachment
                        }
        ...
        // Prevent pop-up close on clicking other elements
    ...
    $('#update-post-submit').on('click', function () {
        ...
        var networkId = $('#edit-post-network').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                // 'nonce': blueskyPoster.nonce, // Commented out for now
            },
            success: function (response) {
                if (response.success) {
