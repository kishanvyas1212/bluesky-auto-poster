 ...
 */
function text_poster($username, $password, $message) {
    // Bluesky API URLs
...
function bluesky_post_with_attachment($username, $password, $message, $attachment_path) {
    // API URLs
    $login_url = "https://bsky.social/xrpc/com.atproto.server.createSession";
...
$body = "--$delimiter\r\n";
$body .= "Content-Disposition: form-data; name=\"file\"; filename=\"$image_filename\"\r\n";
